...
; SELECT nothing from valid table
(test
 (SELECT '() FROM Person)
 '(()()())
 )

; Select something from empty table
(test (SELECT '("Name") FROM '(())) '(()))

; Select something from table with only attributes
(test (SELECT '("Name") FROM '(("Name" "Age"))) '())
...
;Three tables
(test (SELECT * FROM [Person "P"] [Teaching "T"] [Drinks "D"])
'(("P.Name" "Age" "LikesChocolate" "T.Name" "Course" "D.Name" "Drink")
  ("David" 20 #t "David" "CSC324" "Sean" "Pepsi")
  ("David" 20 #t "David" "CSC324" "Marco" "OJ")
  ("David" 20 #t "David" "CSC324" "Mikhail" "Water")
  ("David" 20 #t "Paul" "CSC108" "Sean" "Pepsi")
  ("David" 20 #t "Paul" "CSC108" "Marco" "OJ")
  ("David" 20 #t "Paul" "CSC108" "Mikhail" "Water")
  ("David" 20 #t "David" "CSC343" "Sean" "Pepsi")
  ("David" 20 #t "David" "CSC343" "Marco" "OJ")
  ("David" 20 #t "David" "CSC343" "Mikhail" "Water")
  ("Jen" 30 #t "David" "CSC324" "Sean" "Pepsi")
  ("Jen" 30 #t "David" "CSC324" "Marco" "OJ")
  ("Jen" 30 #t "David" "CSC324" "Mikhail" "Water")
  ("Jen" 30 #t "Paul" "CSC108" "Sean" "Pepsi")
  ("Jen" 30 #t "Paul" "CSC108" "Marco" "OJ")
  ("Jen" 30 #t "Paul" "CSC108" "Mikhail" "Water")
  ("Jen" 30 #t "David" "CSC343" "Sean" "Pepsi")
  ("Jen" 30 #t "David" "CSC343" "Marco" "OJ")
  ("Jen" 30 #t "David" "CSC343" "Mikhail" "Water")
  ("Paul" 100 #f "David" "CSC324" "Sean" "Pepsi")
  ("Paul" 100 #f "David" "CSC324" "Marco" "OJ")
  ("Paul" 100 #f "David" "CSC324" "Mikhail" "Water")
  ("Paul" 100 #f "Paul" "CSC108" "Sean" "Pepsi")
  ("Paul" 100 #f "Paul" "CSC108" "Marco" "OJ")
  ("Paul" 100 #f "Paul" "CSC108" "Mikhail" "Water")
  ("Paul" 100 #f "David" "CSC343" "Sean" "Pepsi")
  ("Paul" 100 #f "David" "CSC343" "Marco" "OJ")
  ("Paul" 100 #f "David" "CSC343" "Mikhail" "Water"))
 )
;Three attritbutes from three tables
(test
(SELECT '("T.Name" "P.Name" "D.Name") FROM [Person "P"] [Teaching "T"] [Drinks "D"])
'(("T.Name" "P.Name" "D.Name")
  ("David" "David" "Sean")
  ("David" "David" "Marco")
  ("David" "David" "Mikhail")
  ("Paul" "David" "Sean")
